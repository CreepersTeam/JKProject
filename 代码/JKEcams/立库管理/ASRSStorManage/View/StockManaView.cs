    ...
    public partial class StockManaView : BaseChildView
    {
        ...
        private void tsb_QueryStock_Click(object sender, EventArgs e)
        {
            ...
            this.presenter.QueryStock(this.cb_StoreHouse.Text, this.cb_HouseArea.Text,this.cb_StockRow.Text, this.cb_StockColumn.Text, this.cb_StockLayer.Text
                , this.cb_GSStatus.Text, this.cb_GSTaskType.Text,this.cb_ProductBatch.Text);
        }
        ...
        private void ModifyGsStatus()
        {
            ...
            if (egsv.IsSure == true)
            {
                ...
                for (int i = 0; i < this.dgv_StockInfor.SelectedRows.Count; i++)
                {
                    ...
                    int rowth = int.Parse(this.dgv_StockInfor.SelectedRows[i].Cells["rowth"].Value.ToString());
                    int colth = int.Parse(this.dgv_StockInfor.SelectedRows[i].Cells["colth"].Value.ToString());
                    int layerth = int.Parse(this.dgv_StockInfor.SelectedRows[i].Cells["layerth"].Value.ToString());
        ...
        private void OutputManual()
        {
            ...
            for (int i = 0; i < this.dgv_StockInfor.SelectedRows.Count; i++)
            {
                string stockIDStr = this.dgv_StockInfor.SelectedRows[i].Cells["StockID"].Value.ToString();
                string outputManual = this.dgv_StockInfor.SelectedRows[i].Cells["gs_TaskStatus"].Value.ToString();
        ...
        private void tsb_UseGS_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.dgv_StockInfor.SelectedRows.Count; i++)
            {
                string stockID = this.dgv_StockInfor.SelectedRows[i].Cells["StockID"].Value.ToString();
