...
namespace AsrsInterface
{
    ...
    public interface IAsrsManageToCtl
    {
        ...
        bool GetHouseAreaLeftGs(string houseName, string houseAreaName, ref int gsCount,ref string reStr);
        ...
        /// <returns>执行状态</returns>
        bool GetAreaCells(string houseName, string areaName, ref List<CellCoordModel> cells, bool isFull);
        /// <summary>
        /// 获取立库单元格数量情况
        /// </summary>
        /// <param name="houseName">库房名称</param>
