...
namespace MesDBAccess.BLL
{
    ...
    public partial class ProductOnlineBll
    {
        ...
        public ProductOnlineModel GetModelByProcessStepID(string processStepID)
        {
            string whereStr = "processStepID = '" + processStepID + "' and palletBinded = 1";
            List<ProductOnlineModel> onLineData = GetModelList(whereStr);
