...
public interface Iliku
{
    ...
    string ScanBind20(string sns);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Iliku/ScanBind20", ReplyAction="http://tempuri.org/Iliku/ScanBind20Response")]
    System.Threading.Tasks.Task<string> ScanBind20Async(string sns);
}
...
public partial class IlikuClient : System.ServiceModel.ClientBase<Iliku>, Iliku
{
    ...
    public string ScanBind20(string sns)
    {
        return base.Channel.ScanBind20(sns);
    }
    
    public System.Threading.Tasks.Task<string> ScanBind20Async(string sns)
    {
        return base.Channel.ScanBind20Async(sns);
    }
}
